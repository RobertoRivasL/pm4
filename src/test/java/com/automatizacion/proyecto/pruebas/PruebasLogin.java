...
public class PruebasLogin extends BaseTest {
    ...
    @Test(priority = 2,
          ...
          description = "Verificar login con múltiples usuarios válidos",
          groups = {"regression", "login", "positivo"})
    ...
    @Test(priority = 4,
          description = "Verificar login con email vacío",
    ...
    @Test(priority = 5,
          description = "Verificar login con password vacío",
          groups = {"regression", "login", "negativo", "validacion"})
    @Story("Validación de Campos")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 6,
          ...
          dataProviderClass = ProveedorDatos.class,
          description = "Verificar login con datos inválidos desde proveedor de datos",
    ...
    @Test(priority = 7,
          description = "Verificar funcionalidad 'Recordarme'",
          groups = {"regression", "login", "funcionalidad"})
    ...
    @Test(priority = 8,
          description = "Verificar enlace 'Olvidé mi contraseña'",
          groups = {"regression", "login", "navegacion"})
    @Story("Navegación")
    @Severity(SeverityLevel.MINOR)
    ...
    @Test(priority = 9,
          description = "Verificar enlace de registro",
          groups = {"regression", "login", "navegacion"})
    @Story("Navegación")
    @Severity(SeverityLevel.MINOR)
    ...
    @Test(priority = 10,
          description = "Verificar bloqueo por múltiples intentos fallidos",
          groups = {"security", "login", "negativo"},
          enabled = true)
    @Story("Seguridad")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 11,
          description = "Verificar caracteres especiales en credenciales",
          groups = {"security", "login", "edge-cases"})
    @Story("Casos Borde")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 12,
          description = "Verificar tiempo de respuesta del login",
