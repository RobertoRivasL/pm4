...
public class PruebasRegistro extends BaseTest {
    ...
    @Test(priority = 2,
          ...
          description = "Verificar registro con múltiples conjuntos de datos válidos",
    ...
    @Test(priority = 3,
          description = "Verificar validación de campo nombre vacío",
    ...
    @Test(priority = 6,
          description = "Verificar validación de contraseña débil",
          groups = {"security", "registro", "negativo", "validacion"})
    ...
    @Test(priority = 7,
          ...
          dataProviderClass = ProveedorDatos.class,
          description = "Verificar registro con datos inválidos desde proveedor de datos",
          groups = {"regression", "registro", "negativo"})
    ...
    @Test(priority = 8,
          description = "Verificar validación de usuario existente",
          groups = {"regression", "registro", "negativo", "usuario-existente"})
    ...
    @Test(priority = 9,
          description = "Verificar validación de términos y condiciones no aceptados",
          groups = {"regression", "registro", "negativo", "validacion"})
    ...
    @Test(priority = 10,
          description = "Verificar funcionalidad de campos opcionales",
          groups = {"regression", "registro", "funcionalidad"})
    ...
    @Test(priority = 11,
          description = "Verificar funcionalidad de newsletter",
          groups = {"regression", "registro", "funcionalidad"})
    @Story("Newsletter")
    @Severity(SeverityLevel.MINOR)
    ...
    @Test(priority = 12,
          description = "Verificar limpieza de formulario",
          groups = {"ui", "registro", "funcionalidad"})
    ...
    @Test(priority = 13,
          description = "Verificar enlace de navegación a login",
          groups = {"regression", "registro", "navegacion"})
    @Story("Navegación")
    @Severity(SeverityLevel.MINOR)
    ...
    @Test(priority = 14,
          description = "Verificar tiempo de respuesta del registro",
          groups = {"performance", "registro"})
    @Story("Performance")
    @Severity(SeverityLevel.MINOR)
    ...
    @Test(priority = 15,
          description = "Verificar elementos de la interfaz de usuario",
          groups = {"ui", "registro"})
    ...
    public void testElementosInterfazUsuario() {
        ...
        boolean elementosValidos = paginaRegistro.validarElementosPagina();
        Assert.assertTrue(elementosValidos, 
    ...
    @Test(priority = 16,
          description = "Verificar caracteres especiales en campos de texto",
          groups = {"security", "registro", "edge-cases"})
    @Story("Seguridad")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Test(priority = 17,
          description = "Verificar prevención de inyección de scripts",
          groups = {"security", "registro", "xss"})
    @Story("Seguridad XSS")
    @Severity(SeverityLevel.CRITICAL)
    ...
    @Test(priority = 18,
          description = "Verificar campos con longitud máxima",
          groups = {"edge-cases", "registro", "validacion"})
    @Story("Casos Borde")
    @Severity(SeverityLevel.MINOR)
